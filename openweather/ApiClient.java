...
import openweather.auth.Authentication;
import openweather.auth.HttpBasicAuth;
import openweather.auth.HttpBearerAuth;
import openweather.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.openweathermap.org";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.openweathermap.org)
     ...
     * @return a {@link openweather.ApiClient} object
     */
    ...
    */
     ...
     * @throws openweather.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws openweather.ApiException If fail to serialize the given object
     */
     ...
     * @throws openweather.ApiException If fail to read file content from response and write to disk
     ...
     * @throws openweather.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws openweather.ApiException If the response has an unsuccessful status code or
     ...
     * @throws openweather.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws openweather.ApiException If fails to update the parameters
     */
     ...
     * @throws openweather.ApiException If fail to serialize the request body object into a string
     */
